  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-grid">
        ...
        <div>
          <img src="/brand/logo-footer.png" alt="Auto Drive Veículos" className="footer-logo" />
        ...
        <div>
          ...
          <a href={MAPS_ROTA_URL} target="_blank" rel="noreferrer" className="footer-address">
            ...
            <span>{ENDERECO.linha1}<br/>{ENDERECO.complemento}<br/>{ENDERECO.bairro} — {ENDERECO.cidade}/{ENDERECO.estado}<br/>CEP {ENDERECO.cep}</span>
          </a>
