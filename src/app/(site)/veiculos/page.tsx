...
export default async function VehiclesPage({ searchParams }: { searchParams: Promise<Record<string, string>> }) {
  ...
  return (
    <>
      <section className="page-hero"><div className="shell"><p className="eyebrow">Estoque Autodrive</p><h1>Encontre seu próximo veículo</h1><p>Use a busca, filtros e origem do veículo para encontrar a melhor oportunidade.</p></div></section>
